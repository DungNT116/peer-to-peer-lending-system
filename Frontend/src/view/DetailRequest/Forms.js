          ...
          <Col xs="12" md="12">
            <Card>
              ...
              <CardFooter>
                ...
                <Button type="submit" size="sm" color="primary" onClick={this.toggleModal}><i className="fa fa-dot-circle-o"></i> Change</Button>{' '}
                <Button type="reset" size="sm" color="danger"><i className="fa fa-ban"></i> Delete</Button>{' '}
